...
project = 'advent-of-code-explainer'
copyright = '2024, Nathan Levett'
...
html_theme_options = {
    "source_repository": "https://github.com/Skenvy/advent-of-code-explainer/",
    "source_branch": "gh-pages-pkg",
